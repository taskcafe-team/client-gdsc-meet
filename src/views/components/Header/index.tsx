...
const Header: React.FC<HeaderProps> = ({ type, className, ...rest }) => {
	...
	return (
		...
		>
          ...
          /> */}
					<h1 className="dark:text-orange text-gray-70  opacity-100 text-[45px] max-lg:text-[25px] font-bold">
						GDSC Meet
					</h1>
				</div>
			</a>
			...
			>
				<BiAlignRight className="text-24 " />
			</div>
			<div
				onClick={() => setTriggerToggle(!triggerToggle)}
			...
			>
				<Link to="/">
					<div className="flex items-center">
						<div
							className="text-gray-70 text-20 flex items-center justify-center"
							onClick={() => setTriggerToggle(!triggerToggle)}
						>
				...
				<div className="text-gray-70 font-roboto text-[15px] dark:text-white transition font-bold">
				...
				<div className="text-gray-70 font-roboto text-[15px] dark-text-white transition font-bold"></div>
